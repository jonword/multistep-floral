  ...
  return (
    <>
      ...
      >
        ...
        <p className="">Name:</p>
        <input type="text" name="name" className="rounded-md p-2" />
        <p className="">Email:</p>
        <input
          type="email"
          name="email"
        ...
        <p>Venue:</p>
        <input type="text" name="venue" id="venue" className="rounded-md p-2" />
        ...
        <input
          ...
          className="rounded-md p-2"
        />
        <button className="mx-auto mt-2 flex items-center px-12 py-4 text-lg font-bold text-white bg-gray-800 hover:bg-green-800 duration-200 rounded-lg">
          Send
        </button>
      </form>
    </>
